...
(@) Calculate the volume of water ($V_{base}$) beneath the base flow hydrograph between the first and last date of interest. The volume (m<sup>3</sup>) is simply derived as the sum of the daily base flow values multiplied by `r fmt_number(86400)` (the number of seconds per day = `r fmt_number(86400)`).
