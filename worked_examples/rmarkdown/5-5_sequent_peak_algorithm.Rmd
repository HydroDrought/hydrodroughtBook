...
flows below the $Q_90$ contributes to the storage. This happens the first time on `r ng$time[ng$storage > 0][1]` and lasts only two days.
...
```{r, echo=FALSE, }
fig.cap <- "Figure x.xx Depiction of the relationship between discharge $Q_t$ and storage $Q_t$ for the third drought event starting 1989-05-24."
```
